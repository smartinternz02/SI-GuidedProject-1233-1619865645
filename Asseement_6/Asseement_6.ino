...
const char* ssid = "civil war";//your wifi ssid
const char* password = "03122001";//your password

// CHANGE TO YOUR DEVICE CREDENTIALS AS PER IN IBM BLUMIX
#define ORG "f69d3z"
#define DEVICE_TYPE "ESP32"
#define DEVICE_ID "24282 "
#define TOKEN "Saikumar2428@" //  Authentication Token OF THE DEVICE
//  PIN DECLARATIONS 
